      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        >
          <div className="flex w-[350px] flex-col gap-2 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
            ...
            <a
              target="blank"
              href="https://bidhannath-ui.com/pro?ref=live-pro-tailwind-react"
            ...
            <a
              target="blank"
              href="https://bidhannath-ui.com/docs-tailwind/docs/react/installation?ref=live-pro-tailwind-react"
            ...
            <a
              target="blank"
              href="https://bidhannath-ui.com/?ref=live-pro-tailwind-react"
