...
const Sidebar = () => {
  ...
  if(session && !pathCondition) {
    return (
      <aside
      className="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0 px-5 py-5"
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex-row items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <br/>
        <div className='text-white dark:text-gray-200'>Hi {session?.user?.email}</div>
        <button onClick={() => signOut()} className='border rounded-md text-white dark:text-gray-200'>Sign out</button>
      </div>
      {/* <!-- SIDEBAR HEADER --> */}
      <div
  ...
  >
    {/* <!-- Sidebar Menu --> */}
    <nav
      className="mt-5 py-4 px-4 lg:mt-9 lg:px-6 text-white"
        ...
        <ul className="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            ...
            <div
              ...
              // :className="(selected === 'Dashboard') ? 'block' :'hidden'"
            >
          ...
          <li>
            <a
              ...
              // :className="{ 'bg-graydark dark:bg-meta-4': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout') }"
            >
              <svg
                className="fill-current"
                width="18"
              ...
              <svg
                className="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                // :className="{ 'rotate-180': (selected === 'Forms') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              className="overflow-hidden"
              // :className="(selected === 'Forms') ? 'block' :'hidden'"
            >
              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    ...
                    // :className="page === 'formElements' && '!text-white'"
                    >Form Elements</a
                  >
                </li>
                <li>
          ...
          <li>
            <a
              ...
              // :className="{ 'bg-graydark dark:bg-meta-4': (selected === 'Tables') && (page === 'Tables') }"
            >
              <svg
                className="fill-current"
                width="18"
        ...
        <ul className="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              // :className="{ 'bg-graydark dark:bg-meta-4': (selected === 'Chart') && (page === 'Chart') }"
            >
              <svg
                className="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              // :className="{ 'bg-graydark dark:bg-meta-4': (selected === 'UiElements') || (page === 'alerts' || page === 'buttons' || page === 'card' || page === 'tabs' || page === 'modals') }"
            >
              <svg
                className="fill-current"
                width="18"
              ...
              <svg
                className="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                // :className="{ 'rotate-180': (selected === 'UiElements') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              className="overflow-hidden"
              // :className="(selected === 'UiElements') ? 'block' :'hidden'"
            >
              <ul className="mt-4 mb-3 flex flex-col gap-2 pl-6">
                <li>
                  <a
                    className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="alerts.html"
                    // :className="page === 'alerts' && '!text-white'"
                    >Alerts</a
                  >
                </li>
                <li>
                  <a
                    className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="buttons.html"
                    // :className="page === 'buttons' && '!text-white'"
                    >Buttons</a
                  >
                </li>
              </ul>
          ...
          <li>
            <a
              ...
              // :className="{ 'bg-graydark dark:bg-meta-4': (selected === 'AuthPages') || (page === 'register' || page === 'login' || page === 'forgetPassword') }"
            >
              <svg
                className="fill-current"
                width="18"
              ...
              <svg
                className="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                // :className="{ 'rotate-180': (selected === 'AuthPages') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              className="overflow-hidden"
              // :className="(selected === 'AuthPages') ? 'block' :'hidden'"
            >
              <ul className="mt-4 mb-3 flex flex-col gap-2 pl-6">
                <li>
                  <a
  ...
  if(!session) {  
    return (
      <>
      {!session &&
      <div className='absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-gray-800 lg:static lg:translate-x-0 px-5 py-5 text-white dark:text-gray-200'>
        Not signed in <br/>
        <button onClick={() => signIn()} className='border rounded-md'>Sign In</button>
      </div>
      }
      </>
    )
